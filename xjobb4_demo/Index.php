...
$start = new StartIndexController;
$start->routes();
require(TEMPLATES_FOLDER.'cart.tpl.php');
*/
//ladda upp autoloadern
include 'Autoloader.php';
Autoloader::register();
//Instansiera startIndexClass och routes metoden
$startIndexController = new startIndexController;
$startIndexController->routes();
//include(TEMPLATES_FOLDER.'cart.tpl.php');